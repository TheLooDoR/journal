...
module.exports = {
    ...
    confirm: id => ({
        ...
        text: `Скопируйте и вставте данную ссылку: ${CLIENT_ORIGIN}/email-confirm/${id}`
    }),
    ...
    forgotPassword: token => ({
        ...
        text: 'Вы получили данное сообщение потому что вы (или кто-то другой) сделали запрос на восстановление пароля к вашему аккаунту.\n \n'
            + 'Пожалуйста, перейдите по прикреплённой ссылке или вставьте её в браузер для завершения процесса восстановления в течение часа.\n \n'
