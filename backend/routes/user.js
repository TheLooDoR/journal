...
router.get('/random-users', passport.authenticate('jwt', { session: false }), controller.getRandom)
router.get('/users-select', passport.authenticate('jwt', { session: false }), controller.getUsersSelect)
